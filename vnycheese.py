...
▀▄▄▄▄▄▀▄▀▄▀▄▄▄▄▄▀▄▄▄▄▄▀▄▄▄▄▄▀▄▄▄▄▄▀
    ...
    if menu == 1:
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "ENTER TUSUNA BAS DEVAM ET : "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
        ...
        print(Fore.LIGHTRED_EX + "\nMenüye dönmek için 'enter' tuşuna basınız..")
        input()
    elif menu == 1212121211:
        system("cls||clear")
        print(Fore.LIGHTWHITE_EX + " ")
        print(Fore.LIGHTWHITE_EX + "6saniye sonra anamenüye yönlendirilceksiniz. ")
        sleep(6)
        continue
    elif menu == 2:
        system("cls||clear")
